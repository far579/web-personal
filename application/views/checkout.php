                        ...
                        <div id="content" class="tab-pane p-5 active" role="tabpanel" aria-labelledby="content-tab">
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                ...
                                <div class="mt-5">
                                    ...
                                    <div class="mb-5">
                                        <label for="post-form-7" class="form-label">Nomor Telephone <small class="text-danger">*</small></label>
                            ...
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5 mt-5">
                                ...
                                <div class="mt-5">
                                    <div class="mb-5">
                                        ...
                                        <input type="text" id="alamat" name="alamat" class="form-control" placeholder="" autocomplete="off" required>
                                    </div>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input type="text" class="form-control" id="kode_pos" name="kode_pos" placeholder="" autocomplete="off" required>
                                    </div>

                                    <div class="mb-5">
                                        <label for="post-form-7" class="form-label">Pilih Pengiriman <small class="text-danger">*</small></label>
                            ...
                            <div class="flex mt-5">
                                ...
                                <button type="submit" class="btn btn-primary w-32 shadow-md ml-auto">Pembayaran</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div id="ticket" class="tab-pane active" role="tabpanel" aria-labelledby="ticket-tab">
                <div class="box p-2 mt-5">
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        ...
                        <div class="ml-auto font-medium">67500009 / KIRNAID Commerce</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                        ...
                        <div class="text-slate-500"></div>
                        <div class="ml-auto font-medium">19180000817 / KIRNAID Commerce</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                        ...
                        <div class="text-slate-500"></div>
                        <div class="ml-auto font-medium">67215008021 / KIRNAID Commerce</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                        ...
                        <div class="text-slate-500"></div>
                        <div class="ml-auto font-medium">675052777090 / KIRNAID Commerce</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                        ...
                        <div class="text-slate-500"></div>
                        <div class="ml-auto font-medium">675052709009 / KIRNAID Commerce</div>
                    </a>
                </div>
